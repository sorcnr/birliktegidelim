...
const Schema: z.ZodType<Prisma.DriverUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const DriverUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
