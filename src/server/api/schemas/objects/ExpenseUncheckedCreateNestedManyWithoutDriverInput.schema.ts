...
const Schema: z.ZodType<Prisma.ExpenseUncheckedCreateNestedManyWithoutDriverInput> =
  z
    .object({
      create: z
        .union([
...
export const ExpenseUncheckedCreateNestedManyWithoutDriverInputObjectSchema =
  Schema;
