...
const Schema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutDriverNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ExpenseUpdateManyWithWhereWithoutDriverInputObjectSchema
          ),
          z
            .lazy(
              () => ExpenseUpdateManyWithWhereWithoutDriverInputObjectSchema
...
export const ExpenseUncheckedUpdateManyWithoutDriverNestedInputObjectSchema =
  Schema;
