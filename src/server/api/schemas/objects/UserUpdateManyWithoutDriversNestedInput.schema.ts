...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutDriversNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutDriversInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutDriversInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutDriversInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutDriversInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutDriversNestedInputObjectSchema = Schema;
