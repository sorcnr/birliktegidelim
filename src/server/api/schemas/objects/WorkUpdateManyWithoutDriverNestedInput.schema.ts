...
const Schema: z.ZodType<Prisma.WorkUpdateManyWithoutDriverNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => WorkUncheckedCreateWithoutDriverInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => WorkCreateOrConnectWithoutDriverInputObjectSchema),
        z.lazy(() => WorkCreateOrConnectWithoutDriverInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const WorkUpdateManyWithoutDriverNestedInputObjectSchema = Schema;
