...
import { DriverUncheckedUpdateManyWithoutUsersNestedInputObjectSchema } from "./DriverUncheckedUpdateManyWithoutUsersNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutAccountsInput> = z
  .object({
    ...
    sessions: z
      ...
      .optional(),
    drivers: z
      .lazy(() => DriverUncheckedUpdateManyWithoutUsersNestedInputObjectSchema)
      .optional(),
  })
  .strict();
