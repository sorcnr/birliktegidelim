...
const Schema: z.ZodType<Prisma.DriverUpdateManyWithoutCarsNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => DriverUncheckedCreateWithoutCarsInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => DriverCreateOrConnectWithoutCarsInputObjectSchema),
        z.lazy(() => DriverCreateOrConnectWithoutCarsInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const DriverUpdateManyWithoutCarsNestedInputObjectSchema = Schema;
