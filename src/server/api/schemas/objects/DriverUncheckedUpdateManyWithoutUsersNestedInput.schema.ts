...
const Schema: z.ZodType<Prisma.DriverUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => DriverUpsertWithWhereUniqueWithoutUsersInputObjectSchema
          ),
          z
            .lazy(
              () => DriverUpsertWithWhereUniqueWithoutUsersInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => DriverUpdateWithWhereUniqueWithoutUsersInputObjectSchema
          ),
          z
            .lazy(
              () => DriverUpdateWithWhereUniqueWithoutUsersInputObjectSchema
...
export const DriverUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
