...
import { DriverUpdateManyWithoutUsersNestedInputObjectSchema } from "./DriverUpdateManyWithoutUsersNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutSessionsInput> = z
  .object({
    ...
    accounts: z
      ...
      .optional(),
    drivers: z
      .lazy(() => DriverUpdateManyWithoutUsersNestedInputObjectSchema)
      .optional(),
  })
  .strict();
