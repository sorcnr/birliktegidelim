...
const Schema: z.ZodType<Prisma.WorkUncheckedCreateNestedManyWithoutCarInput> = z
  .object({
    create: z
      .union([
...
export const WorkUncheckedCreateNestedManyWithoutCarInputObjectSchema = Schema;
