...
const Schema: z.ZodType<Prisma.WorkUncheckedUpdateManyWithoutCarNestedInput> = z
  .object({
    create: z
      .union([
...
export const WorkUncheckedUpdateManyWithoutCarNestedInputObjectSchema = Schema;
